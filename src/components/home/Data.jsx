...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Albert Leonardi
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a front-end developer with expertise in creating interactive and engaging user experiences using the latest web technologies.</p>
